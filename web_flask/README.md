...
## Python, Back-end, Webserver, Flask By: Guillaume, CTO at Holberton School
...
- [Recommended YouTube playlist to get you started](https://youtu.be/QnDWIZuWYW0?list=PL-osiE80TeTs4UjLw5MM6OjgkjFeUxCYH)
...
- Routes:
  - `/`: display “Hello HBNB!”
  - `/hbnb`: display “HBNB”
- You must use the option `strict_slashes=Fals`e in your route definition
...
- Routes:
  - `/hbnb_filters`: display a HTML page like `6-index.html`, which was done during the project [0x01. AirBnB clone - Web static](https://intranet.alxswe.com/rltoken/EG-iGbr_iPTlHrQQSNho1g)
    - Copy files `3-footer.css`, `3-header.css`, `4-common.css` and `6-filters.cs`s from `web_static/styles/` to the folder `web_flask/static/styles`
